...
// Generic function to create default objects
const createDefault = <T>(defaults: T): T => ({ ...defaults });
...
export const defaultPage = {
    ...
    heroImage: createDefault(defaultMedia),
...
export const getDefaultMedia = () => createDefault(defaultMedia);
export const getDefaultPage = () => createDefault(defaultPage);
